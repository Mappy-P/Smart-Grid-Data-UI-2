const parallax_el = document.querySelectorAll('.landing_parallax:not(.text)');
const parallax_text = document.querySelectorAll('.text');
    ...
    parallax_text.forEach(el =>{
        ...
        if (yValue < 0){
            ...
            el.style.transform = `translateX(calc(-50% + ${
                ...
                yValue*speedy
            }vh - 13vh)) perspective(2300px) translateZ(${zValue * speedz}vh)`;
            el.style.opacity = '1';
          }
          else{
            el.style.transform = `translateX(calc(-50% + ${
